...
# Covert high elevation values into polygon shapes and then transform into a sf 
...
# Crop full Bryce to our area of interest 
...
```{r}
# Transform OSM to match crs of Bryce 
...
render_camera(theta=240,  phi=30, zoom=0.9,  fov=60)
render_snapshot()
```
